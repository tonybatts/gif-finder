...
elArr = [...document.querySelectorAll("a, p, div, section, aside, span, h1, h2, h3, h4, h5, h6, body, footer, nav, article, main, blockquote, button")]
elArr.forEach((el) => {
...
chrome.runtime.sendMessage(JSON.stringify(colorArr))
